// converts km to mi for all your egg and buddy-walking needs!
function conv(dist)
{
    var out;
    if (dist == "km")
    {
        //out = MILES = 1.609344*(km)
        out = document.getElementById("km").value * 0.621371;
        document.getElementById("mi").value = out;
    }
    else if (dist == "mi")
    {
        //out = KILOMETERS = 0.621371*(m)
        out = document.getElementById("mi").value * 1.609344;
        document.getElementById("km").value = out;
    }
...
// for confetti! from https://github.com/tobysmith568/Confetti-Chrome-Extension/blob/master/src/inject.js
...
// Sourced from class instructions @ https://github.com/galaxykate/CS396-GenMeth-21S/blob/main/a1.md
document.addEventListener("DOMContentLoaded", function(){
	console.log("WHAT'S UP I'M NICOLE AND WELCOME TO MY BLOG! *air horn noise air horn noise air horn noise*")
});