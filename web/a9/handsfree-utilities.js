...
// I was just experimenting with the values a bit, but they should all be set back to the default! -Nicole
let handsfree
...
const faceIndexes = {
	...
	// RIGHT
	{
		...
		// eyeRings: [
		// 	[222, 268, 207, 166, 205, 163, 170, 256, 243, 216, 223, 150, 201, 200, 147, 214, 288],
		// 	[345, 293, 155, 165, 152, 153, 146, 224, 135, 211, 217, 218, 219, 220, 221, 228],
		// 	[344, 289, 321, 322, 323, 324, 325, 213, 326, 131, 328, 329, 330, 331, 332, 333],
		// 	[343, 290, 156, 128, 127, 129, 130, 347, 230, 125, 210, 124, 123, 122, 126, 212],
		// 	[233, 273, 257, 258, 259, 260, 261, 346, 133, 107, 263, 244, 245, 253, 254, 255],
		// ],
		// eyeRings: [
		// 	[22, 68, 07, 66, 05, 63, 70, 56, 43, 16, 23, 50, 01, 00, 47, 14, 88],
		// 	[145, 93, 55, 65, 52, 53, 46, 24, 35, 11, 17, 18, 19, 20, 21, 28],
		// 	[144, 89, 121, 122, 123, 124, 125, 13, 126, 31, 128, 129, 130, 131, 132, 133],
		// 	[143, 90, 56, 28, 27, 29, 30, 147, 30, 25, 10, 24, 23, 22, 26, 12],
		// 	[33, 73, 57, 58, 59, 60, 61, 146, 33, 07, 63, 44, 45, 53, 54, 55],
		// ],
		// eyeRings: [
...
// face.mouth = faceIndexes.mouth.map(mouthLine => mouthLine.map(index => face.points[index]+100))
