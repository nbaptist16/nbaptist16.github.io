...
document.addEventListener("DOMContentLoaded", function(){
	...
	new Vue({
		...
		<div id="controls">
			...
			<p style="position: relative; bottom: -35px;">pretty cool 'stume, huh?</p>
			<img style="position: relative; bottom: -40px; margin: auto; width: 200px; height: auto;" src="../src/boyle_stume_croppd.png">
